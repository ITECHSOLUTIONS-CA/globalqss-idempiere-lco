...
import dev.itechsolutions.webui.window.WLocationDialogExt;
 ...
 **/
public class WLocationEditorExt extends WEditor implements EventListener<Event>, PropertyChangeListener, ContextMenuListener, IZoomableEditor
{
    private static final String[] LISTENER_EVENTS = {Events.ON_CLICK};
    
    private static final CLogger log = CLogger.getCLogger(WLocationEditorExt.class);
    private MLocationLookupExt     m_Location;
    private MITSLocation           m_value;
     ...
     * @param MITSLocation     location model
    **/
    public WLocationEditorExt(String columnName, boolean mandatory, boolean isReadOnly, boolean isUpdateable,
     ...
     * @param gridField
     */
    public WLocationEditorExt(GridField gridField) {
     ...
     */
    public WLocationEditorExt(GridField gridField, boolean tableEditor, IEditorConfiguration editorConfiguration) {
    ...
    {    
        ...
        if ("onClick".equals(event.getName()))
        {
            ...
            final WLocationDialogExt ld = new WLocationDialogExt(Msg.getMsg(Env.getCtx(), "Location"), m_value, gridField);
            ...
            ld.addEventListener(DialogEvents.ON_WINDOW_CLOSE, new EventListener<Event>() {
				...
				public void onEvent(Event event) throws Exception {
		            ...
		            {
		                ValueChangeEvent vc = new ValueChangeEvent(WLocationEditorExt.this,getColumnName(),null,ii);
		                fireValueChange(vc);
		            }
		            setValue(ii);					
				}
