...
@org.adempiere.base.Model(table="C_Parish")
...
// @C_Region_ID@
    ...
    /** Standard Constructor */
    public X_C_Parish (Properties ctx, int C_Parish_ID, String trxName, String ... virtualColumns)
    {
...
// @C_Region_ID@
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_Parish[")
	...
	*/
	...
	{
		return (I_C_Municipality)MTable.get(getCtx(), I_C_Municipality.Table_ID)
	...
	*/
	...
	{
		set_ValueNoCheck (COLUMNNAME_C_Parish_UU, C_Parish_UU);
	}
