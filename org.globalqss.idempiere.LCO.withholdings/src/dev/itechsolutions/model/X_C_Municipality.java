...
@org.adempiere.base.Model(table="C_Municipality")
...
// @C_Country_ID@
    ...
    /** Standard Constructor */
    public X_C_Municipality (Properties ctx, int C_Municipality_ID, String trxName, String ... virtualColumns)
    {
...
// @C_Country_ID@
    ...
    {
      StringBuilder sb = new StringBuilder ("X_C_Municipality[")
