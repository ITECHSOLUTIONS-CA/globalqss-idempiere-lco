 ...
 */
public final class MLocationLookupExt extends Lookup
	implements Serializable
{
	 ...
	 */
	public MLocationLookupExt(Properties ctx, int WindowNo)
	{
	...
	public String getDisplay (Object value)
	{
		if (value == null)
			return null;
		MITSLocation loc = getLocation (value, null);
		if (loc == null){
	 ...
	 * 	@return Location
	 */
	public MITSLocation getLocation (Object key, String trxName)
	{
		if (key == null)
			return null;
		int C_Location_ID = 0;
	 ...
	 * 	@return Location
	 */
	public MITSLocation getLocation (int C_Location_ID, String trxName)
	{
		return MITSLocation.getCopy(m_ctx, C_Location_ID, trxName);
	}	//	getC_Location_ID
	...
	@Override
	public int getZoom() {
		return MTable.get(MITSLocation.Table_ID).getAD_Window_ID();
	}
