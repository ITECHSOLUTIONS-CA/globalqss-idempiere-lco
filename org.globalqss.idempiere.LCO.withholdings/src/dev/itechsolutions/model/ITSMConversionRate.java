 ...
 *
 */
public class ITSMConversionRate extends MConversionRate {
	...
	private static CLogger		s_log = CLogger.getCLogger (ITSMConversionRate.class);
	
	public ITSMConversionRate(Properties ctx, int C_Conversion_Rate_ID, String trxName) {
		super(ctx, C_Conversion_Rate_ID, trxName);
	}
	
	public ITSMConversionRate(Properties ctx, ResultSet rs, String trxName) {
		super(ctx, rs, trxName);
	}

	public ITSMConversionRate(PO po, int C_ConversionType_ID, int C_Currency_ID, int C_Currency_ID_To,
