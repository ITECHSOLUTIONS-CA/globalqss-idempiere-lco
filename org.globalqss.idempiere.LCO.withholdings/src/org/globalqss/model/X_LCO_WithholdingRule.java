...
@org.adempiere.base.Model(table="LCO_WithholdingRule")
public class X_LCO_WithholdingRule extends PO implements I_LCO_WithholdingRule, I_Persistent 
{
    ...
    /** Standard Constructor */
    public X_LCO_WithholdingRule (Properties ctx, int LCO_WithholdingRule_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LCO_WithholdingRule_ID, trxName, virtualColumns);
      /** if (LCO_WithholdingRule_ID == 0)
        {
			setLCO_WithholdingRule_ID (0);
			setName (null);
	...
	*/
	...
	{
		return (org.globalqss.model.I_LCO_ISIC)MTable.get(getCtx(), org.globalqss.model.I_LCO_ISIC.Table_ID)
	...
	*/
	...
	{
		return (org.globalqss.model.I_LCO_TaxPayerType)MTable.get(getCtx(), org.globalqss.model.I_LCO_TaxPayerType.Table_ID)
	...
	*/
	...
	{
		return (org.globalqss.model.I_LCO_WithholdingCalc)MTable.get(getCtx(), org.globalqss.model.I_LCO_WithholdingCalc.Table_ID)
	...
	*/
	...
	{
		return (org.globalqss.model.I_LCO_WithholdingCategory)MTable.get(getCtx(), org.globalqss.model.I_LCO_WithholdingCategory.Table_ID)
