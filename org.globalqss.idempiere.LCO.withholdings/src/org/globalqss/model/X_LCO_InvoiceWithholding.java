...
@org.adempiere.base.Model(table="LCO_InvoiceWithholding")
public class X_LCO_InvoiceWithholding extends PO implements I_LCO_InvoiceWithholding, I_Persistent 
{
    ...
    public X_LCO_InvoiceWithholding (Properties ctx, int LCO_InvoiceWithholding_ID, String trxName)
    {
      ...
      /** if (LCO_InvoiceWithholding_ID == 0)
        {
			setC_Invoice_ID (0);
			setConvertedTaxAmt (Env.ZERO);
// 0
			setConvertedTaxBaseAmt (Env.ZERO);
// 0
...
// N
    ...
    /** Standard Constructor */
    public X_LCO_InvoiceWithholding (Properties ctx, int LCO_InvoiceWithholding_ID, String trxName, String ... virtualColumns)
    {
      super (ctx, LCO_InvoiceWithholding_ID, trxName, virtualColumns);
      /** if (LCO_InvoiceWithholding_ID == 0)
        {
			setC_Invoice_ID (0);
			setConvertedTaxAmt (Env.ZERO);
...
// N
	...
	*/
	...
	/** Set Converted Tax Amount.
		@param ConvertedTaxAmt Converted Tax Amount
	*/
	public void setConvertedTaxAmt (BigDecimal ConvertedTaxAmt)
	{
		set_Value (COLUMNNAME_ConvertedTaxAmt, ConvertedTaxAmt);
	}

	/** Get Converted Tax Amount.
		@return Converted Tax Amount	  */
	public BigDecimal getConvertedTaxAmt()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ConvertedTaxAmt);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}

	/** Set Converted Tax Base Amount.
		@param ConvertedTaxBaseAmt Converted Tax Base Amount
	*/
	public void setConvertedTaxBaseAmt (BigDecimal ConvertedTaxBaseAmt)
	{
		set_Value (COLUMNNAME_ConvertedTaxBaseAmt, ConvertedTaxBaseAmt);
	}

	/** Get Converted Tax Base Amount.
		@return Converted Tax Base Amount	  */
	public BigDecimal getConvertedTaxBaseAmt()
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_ConvertedTaxBaseAmt);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	*/
	...
	/** Set Is Calc On Allocation.
		@param IsCalcOnAllocation Is Calc On Allocation
	*/
	public void setIsCalcOnAllocation (boolean IsCalcOnAllocation)
	{
		set_Value (COLUMNNAME_IsCalcOnAllocation, Boolean.valueOf(IsCalcOnAllocation));
	}

	/** Get Is Calc On Allocation.
		@return Is Calc On Allocation	  */
	public boolean isCalcOnAllocation()
	{
		Object oo = get_Value(COLUMNNAME_IsCalcOnAllocation);
		if (oo != null) 
		{
