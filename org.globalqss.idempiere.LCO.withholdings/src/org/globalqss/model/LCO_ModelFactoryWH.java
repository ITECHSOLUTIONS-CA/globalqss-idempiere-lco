...
import dev.itechsolutions.model.ITSMGenerateXML;
...
public class LCO_ModelFactoryWH implements IModelFactory {
	...
	public Class<?> getClass(String tableName) {
		...
		if(ITSMGenerateXML.Table_Name.equals(tableName))
			return ITSMGenerateXML.class;
		return null;
	}
	...
	public PO getPO(String tableName, int Record_ID, String trxName) {
		...
		if (ITSMGenerateXML.Table_Name.equals(tableName))
			return new ITSMGenerateXML(Env.getCtx(), Record_ID, trxName);
		return null;
	}
	...
	public PO getPO(String tableName, ResultSet rs, String trxName) {
		...
		if (ITSMGenerateXML.Table_Name.equals(tableName))
			return new ITSMGenerateXML(Env.getCtx(), rs, trxName);
		return null;
	}
}
